...
var resSchema = require("../jsonSchema/outboundMailResponseSchema.json");
var reqSchema = require("../jsonSchema/outboundMailRequestSchema.json");
var DataJson=[{"ServiceDetails":[{"services":[{"resSjson":resSchema,"reqSjson": reqSchema,"authReqd": false ,"task":"outboundMail", "method" : "POST"}],"serviceName":"mail"}]}];
