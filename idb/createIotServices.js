...
var resSchema = require("../jsonSchema/iotResponseSchema.json");
var reqSchema = require("../jsonSchema/iotRequestSchema.json");
var DataJson=[{"ServiceDetails":[{"services":[{"resSjson":resSchema,"reqSjson": reqSchema,"authReqd": false ,"task":"postVibration", "method" : "POST"}],"serviceName":"iot"}]}];
