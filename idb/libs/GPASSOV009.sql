...
-- -----------------------------------------------------
-- Table `GPASSO`.`TASK008MT`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `GPASSO`.`TASK008MT` ;

CREATE TABLE IF NOT EXISTS `GPASSO`.`TASK008MT` (
  `_ID` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `GPASSO`.`SRVS007MT`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `GPASSO`.`SRVS007MT` ;

CREATE TABLE IF NOT EXISTS `GPASSO`.`SRVS007MT` (
  `_ID` INT NOT NULL,
  `MKR_ID` INT NULL DEFAULT NULL,
  `DT_CREATED` DATETIME NULL DEFAULT NULL,
  `ATH_ID` INT NULL DEFAULT NULL,
  ...
  `ENTTL` INT NULL,
  `STATUS` VARCHAR(45) NULL,
  `REQ_SCHEMA` VARCHAR(100) NULL,
  `RES_SCHEMA` VARCHAR(100) NULL,
  PRIMARY KEY (`_ID`),
  CONSTRAINT `RK_TASK007MT_TASK_IDS`
    FOREIGN KEY (`TASK_IDS`)
    REFERENCES `GPASSO`.`TASK008MT` (`_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);

CREATE INDEX `RK_TASK007MT__idx` ON `GPASSO`.`SRVS007MT` (`TASK_IDS` ASC);


-- -----------------------------------------------------
-- Table `GPASSO`.`PAGE006MT`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `GPASSO`.`PAGE006MT` ;

CREATE TABLE IF NOT EXISTS `GPASSO`.`PAGE006MT` (
  `_ID` INT NOT NULL,
  `MKR_ID` INT NULL DEFAULT NULL,
  `DT_CREATED` DATETIME NULL DEFAULT NULL,
  `ATH_ID` INT NULL DEFAULT NULL,
  ...
  CONSTRAINT `RK_SRVS006MT_SERVICE_IDS`
    FOREIGN KEY (`SERVICE_IDS`)
    REFERENCES `GPASSO`.`SRVS007MT` (`_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);

CREATE INDEX `RK_SRVS006MT_SERVICE_IDS_idx` ON `GPASSO`.`PAGE006MT` (`SERVICE_IDS` ASC);


-- -----------------------------------------------------
-- Table `GPASSO`.`PGGR005MT`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `GPASSO`.`PGGR005MT` ;

CREATE TABLE IF NOT EXISTS `GPASSO`.`PGGR005MT` (
  `_ID` INT(10) NOT NULL,
  ...
  CONSTRAINT `RK_PAGE005MT_PAGE_IDS`
    ...
    REFERENCES `GPASSO`.`PAGE006MT` (`_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);

CREATE INDEX `RF_PAGE005MT_PAGE_IDS_idx` ON `GPASSO`.`PGGR005MT` (`PAGE_IDS` ASC);

CREATE INDEX `RK_PAGE005MT_PAGE_IDS` ON `GPASSO`.`PGGR005MT` (`PAGE_IDS` ASC);
...
-- -----------------------------------------------------
-- Table `GPASSO`.`ROLE004MT`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `GPASSO`.`ROLE004MT` ;

CREATE TABLE IF NOT EXISTS `GPASSO`.`ROLE004MT` (
  `_ID` INT NOT NULL,
  `MKR_ID` INT(10) NULL DEFAULT NULL,
  `DT_CREATED` DATETIME NULL DEFAULT NULL,
  `ATH_ID` INT(10) NULL DEFAULT NULL,
  ...
  CONSTRAINT `RK_PGGR004MB_PAGE_GRP_IDS`
    ...
    REFERENCES `GPASSO`.`PGGR005MT` (`_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE INDEX `RK_PGGR004MB_PAGE_GRP_IDS_idx` ON `GPASSO`.`ROLE004MT` (`PAGE_GRP_IDS` ASC);

CREATE INDEX `RK_ROLE003MT_USR_IDS_idx` ON `GPASSO`.`ROLE004MT` (`USR_IDS` ASC);

CREATE INDEX `RK_PGGR004MB_PAGE_GRP_IDS` ON `GPASSO`.`ROLE004MT` (`PAGE_GRP_IDS` ASC);

CREATE INDEX `RK_ROLE003MT_USR_IDS` ON `GPASSO`.`ROLE004MT` (`USR_IDS` ASC);
...
CREATE TABLE IF NOT EXISTS `GPASSO`.`PRTL002MT` (
  ...
  CONSTRAINT `RK_ROLE003MT_ROLE_IDS`
    ...
    REFERENCES `GPASSO`.`ROLE004MT` (`_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
