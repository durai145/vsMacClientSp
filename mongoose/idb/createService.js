...
var resSchema = require("./isValidUserResponseSchema.json");
var reqSchema = require("./isValidUserRequestSchema.json");
var DataJson=[{"ServiceDetails":[{"services":[{"resSjson":resSchema,"reqSjson": reqSchema,"authReqd": false ,"task":"isValidUser", "method" : "POST"}],"serviceName":"userDetails"}]}];
