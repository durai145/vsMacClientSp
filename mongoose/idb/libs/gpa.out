...
, athId: { type: Number, unique: false, required: false, default: ''  } 
, dtModified: { type: Date, unique: false, required: false, default: ''  } 
, service: { type: String, unique: false, required: false, default: ''  } 
, method: { type: String, unique: false, required: false, default: ''  } 
, authReqd: { type: String, unique: false, required: false, default: ''  } 
});
