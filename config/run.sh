...
curl -v  -X POST -H "Content-Type: application/x-www-form-urlencoded"  http://localhost:5000/service/iot/postVibration --data "grantType=password&clientId=CLIENTSP&scope=GPA&iotRequest=[{\"iotRequest\":[{\"appTest\":[{\"value\":\"3\"}] }  ]}];"
